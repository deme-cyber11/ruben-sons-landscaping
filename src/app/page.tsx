          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up animation-delay-300">
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-primary-green text-lg font-semibold rounded-lg hover:bg-cream hover:shadow-lg transition-all hover-lift"
              >
